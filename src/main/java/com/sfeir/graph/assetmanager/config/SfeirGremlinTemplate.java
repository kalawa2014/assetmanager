...
public class SfeirGremlinTemplate implements GremlinOperations, ApplicationContextAware {
	...
	private MappingGremlinConverter mappingConverter;

	private Client gremlinClient;
	private ApplicationContext context;

	public SfeirGremlinTemplate(@NonNull SfeirGremlinFactory factory, @NonNull MappingGremlinConverter converter) {
